...
Today, we will be doing *supervised learning* with the goal of *prediction*. So instead of letting our beliefs and hypotheses about our story drive our selection of variables and worrying about whether our coefficient estimates are accurate, we'll need to run a *lot* of models and find which one is best for predicting the outcome we care about.

## How Do We know Whether We Care About Inference or Prediction?

- If a model is used to make operational decisions? --> *Prediction*.
- If a model is used to explain behavior or outcomes, or allow us to intervene in a process? --> *Inference*.

What are some examples of prediction-focused use cases?
...
We can specify model parameters when we define the model.
